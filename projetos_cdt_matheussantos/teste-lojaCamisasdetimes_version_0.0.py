...
def gerar_cliente():
    ...
    campo_cliente.delete(
        0,
        tk.END
    )

    campo_cliente.insert(
        0,
        nome
    )
...
def mostrar_pedidos():
    ...
    janela_pedidos.title(
        "Historico de Pedidos"
    )

    janela_pedidos.geometry(
        "650x400"
    )
